        ...
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i>
                    <span class="font-weight-semibold">القسم</span></h4>
            </div>
        </div>
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">القسم</span>
                </div>
            </div>
        </div>
    </div>
                                            ...
                                            <div class="list-icons">
                                                <div class="dropdown show">
                                                    ...
                                                    <div class="dropdown-menu" x-placement="bottom-start"
                                                        ...
                                                        <a href="#"
                                                           class="dropdown-item  updated_expenses{{$category->cats_id}}"
                                                           data-toggle="tooltip"
                                                           data-placement="bottom" title=""
                                                           data-original-title="تعديل "
                                                           onclick="updated({{$category->cats_id}})"
